...
const AppLayout: React.FC = () => {
  ...
  const { stats, updateStats, recordGameStarted, clearStats, isLoading } = useGameStats();
  ...
  return (
    <div className={APP_CONTAINER_CLASSNAME} style={containerStyle}>
      ...
      <main className={MAIN_CLASSNAME}>
        <PuzzleGameMain onGameComplete={handleGameComplete} onGameStarted={recordGameStarted} />
      </main>
